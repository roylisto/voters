...
<html lang="en">
    <head>
        ...
        <title>Login - Election Campaign Management System</title>
        <!-- Bootstrap core CSS -->
    ...
    <body class="login-body">
        <div class="container">
            <form class="form-signin" method="post" action="auth/login">
                <h2 class="login form-signin-heading">Election Campaign Management System</br></br><img alt="" src="uploads/favicon.png"></h2>
